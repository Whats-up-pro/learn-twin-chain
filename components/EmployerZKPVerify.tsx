...
const EmployerZKPVerify: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 mt-6">
      <h3 className="text-lg font-bold mb-2">Zero Knowledge Proof: Verify Student Score</h3>
      ...
      <button onClick={handleVerify} className="bg-green-600 text-white px-4 py-1 rounded" disabled={loading}>
        {loading ? 'Verifying...' : 'Verify ZKP'}
      </button>
      {verifyResult && (
        <div className="mt-2">
          <div className="font-bold">Verification Result:</div>
