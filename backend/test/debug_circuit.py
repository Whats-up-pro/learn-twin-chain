#!/usr/bin/env python3
"""
Debug script for module_progress circuit
"""
import json
import subprocess
import os
...
def main():
    ...
    # Update input with correct hash
    ...
    print("\nUpdated input data with correct student hash:")
    print(json.dumps(input_data, indent=2))
    ...
    try:
        ...
        print(f"❌ Error running witness generation: {e}")
